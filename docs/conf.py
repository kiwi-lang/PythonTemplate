#!/usr/bin/env python
"""
TemplateExample documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "TemplateExample"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import TemplateExample.core  # noqa
...
_full_version = TemplateExample.core.__version__
author = TemplateExample.core.__author__
copyright = TemplateExample.core.__copyright__
...
htmlhelp_basename = "TemplateExample-doc"
...
texinfo_documents = [
    (
        ...
        author,
        "TemplateExample",
        TemplateExample.core.__descr__,
        "Miscellaneous",
    ),
]
