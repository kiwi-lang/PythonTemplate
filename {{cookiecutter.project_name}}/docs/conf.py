...
src_path = os.path.abspath(
    os.path.join(docs_src_path, "..", "{{cookiecutter.project_name}}")
)
...
import {{cookiecutter.project_name}}.core  # noqa
...
_full_version = {{cookiecutter.project_name}}.core.__version__
author = {{cookiecutter.project_name}}.core.__author__
copyright = {{cookiecutter.project_name}}.core.__copyright__
...
texinfo_documents = [
    (
        ...
        author,
        "{{cookiecutter.project_name}}",
        {{cookiecutter.project_name}}.core.__descr__,
        "Miscellaneous",
    ),
]
